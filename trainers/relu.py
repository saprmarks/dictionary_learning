"""
Implements the standard ReLU SAE training scheme.
Hyperparameters from Anthropic April update 2023: https://transformer-circuits.pub/2024/april-update/index.html are used by default.
A legacy implementation of the standard SAE training scheme from Towards Monosemanticity is also provided.
"""
import torch as t
...
class ReLUTrainer(SAETrainer):
    """
    Standard ReLU SAE training scheme following the Anthropic April update 2023: https://transformer-circuits.pub/2024/april-update/index.html
    Decoder column norms are NOT constrained to 1.
    This trainer does not support resampling or ghost gradients. 
    This trainer will have fewer dead neurons than the Standard Towards Monosemanticity trainer.
    """
    def __init__(self,
